...
from epipipe.makefile import read_epiomix_makefile
from epipipe.pipeline import Pypeline
...
def parse_args(argv):
    ...
    epipipe.logger.add_optiongroup(parser)
...
def run(config, makefiles):
    ...
    epipipe.logger.initialize(config, logfile_template)
